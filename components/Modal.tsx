//Imports
import { ThumbDownIcon, ThumbUpIcon, VolumeUpIcon } from "@heroicons/react/outline"
import { PlusIcon, VolumeOffIcon, XIcon } from "@heroicons/react/solid"
  ...
  return (
   ...
   className="fixed !top-7 left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll rounded-md scrollbar-hide"
    >
        ...
        {/*Setting and Styling video components*/} 
        <>
            ...
            <div className="space-y-6 text-lg">
                <div className="flex items-center space-x-2 text-sm">
                    <p className="font-semibold text-green-400">
                        {movie!.vote_average *10}% de Aprovação
                    </p>
